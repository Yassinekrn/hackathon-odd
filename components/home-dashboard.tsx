...
import { Leaf, Camera, Bell, Plus, Sun, Droplet, ArrowRight } from "lucide-react"
        ...
        <CardContent className="p-0">
          ...
          <div className="relative bg-background rounded-lg overflow-hidden border border-border shadow-md">
            ...
            <div className="px-4 py-6 flex flex-col min-h-[600px]">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <Card className="col-span-2 bg-primary/10 border-none">
                  <CardContent className="p-4 flex items-center justify-between">
                    <div>
                      <h3 className="font-medium mb-1">Today's Tip</h3>
                      <p className="text-sm text-muted-foreground">Water your basil plant today</p>
                    </div>
                ...
                <Card className="border-primary/20">
                  <CardContent className="p-4 flex flex-col items-center justify-center gap-2">
                    ...
                    <h3 className="font-medium text-center">My Plants</h3>
                ...
                <Card className="border-primary/20">
                  <CardContent className="p-4 flex flex-col items-center justify-center gap-2">
                    ...
                    <h3 className="font-medium text-center">Diagnostics</h3>
                    <Badge variant="outline" className="bg-primary/10 border-none">
                      Scan plant
                    </Badge>
                  </CardContent>
                ...
                <div className="space-y-3">
                  <Card>
                    <CardContent className="p-3 flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <h4 className="font-medium">Water Basil</h4>
                  ...
                  <Card>
                    <CardContent className="p-3 flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <h4 className="font-medium">Fertilize Mint</h4>
              ...
              {/* Recent plants */}
              <div>
                <h2 className="text-xl font-semibold mb-3">Recent Plants</h2>
                <div className="flex gap-3 overflow-x-auto pb-2">
                  {["Basil", "Mint", "Tomato"].map((plant, index) => (
                    <div key={index} className="flex-shrink-0 w-24">
                      ...
                      <p className="text-sm text-center">{plant}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="absolute bottom-6 right-6">
                <Button size="lg" className="rounded-full shadow-lg px-4 gap-2" aria-label="Add new plant">
